...
// const Shop = () => {
//   const cars = useSelector(state => state.inventory);
...
//   // Extract unique values for filters while removing duplicates
...
//       if (filters.make && !car.name.startsWith(filters.make)) return false;
//       return true;
//     })
//     .sort((a, b) => {
...
//                       (isSoldOut || !canAddMore) ? styles.disabledButton : ''
//                     }`}
//                   >
//                     {isSoldOut ? 'Sold Out' : 
